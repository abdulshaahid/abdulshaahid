...
void mainImage(out vec4 o, vec2 C){
  ...
  // Use isotropic coordinates for noise so it doesn't stretch
  float degree=noise(vec2(t*0.1, (tuv.x*ratio)*tuv.y)*uNoiseScale);
  
  // Standard rotation that preserves the [-0.5, 0.5] boundary for blending
  tuv.y*=1.0/ratio;
  ...
  // Use isotropic coordinates for warp inputs so sine waves don't stretch into silk
  tuv.x+=sin(tuv.y*frequency+warpTime)/amplitude;
  tuv.y+=sin((tuv.x*ratio)*(frequency*1.5)+warpTime)/(amplitude*0.5);
